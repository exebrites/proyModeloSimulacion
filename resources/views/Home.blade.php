...
<header class="custom-header py-3 mb-4">
    <nav class="navbar navbar-expand-lg custom-navbar shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold text-light" href="#">🧮 Números Aleatorios</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="#metodo-mixto-de-congruencias">Método Mixto de Congruencias</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            ...
            <section class="mt-5" id="metodo-mixto-de-congruencias">
                ...
                <div class="mb-4">
                    <a href="{{ route('congruencia') }}" class="btn btn-primary btn-lg w-100">Probar Metodo Mixto de Congruencias</a>
                </div>
            </section>
        </div>
    </div>
